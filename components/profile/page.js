...
const ProfilePage = () => {
  ...
  <ul class="footer-box-description">
    ...
    <li> Surronded by <span class="accent-green"> brilliant minds </span> and community (the team, WIT, affinity groups) </li>
    </ul>
</div>
...
<div class="footer-box">
  ...
  <ul class="footer-box-description">
  <li>Need <span class="accent-green"> more confidence </span> - less nerves</li>
    <li>Stephen and Terrence were very supportive - emphasized value of <span class="accent-green"> listening and collaboration</span> in dev</li>
