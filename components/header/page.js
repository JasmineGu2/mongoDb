  ...
  const messages = {
      ...
      stephen: (
        <>
          ...
          <span className="accent-green">your support throughout the process</span>{" "}
          ...
          <br /> <br /> I also{" "}
          <span className="accent-green">appreciate your great callouts</span>—like
          reminding me about that missing space!
        </>
      ),
      terrence: (
        <>
      ...
      melissa: (
        <>
          Hi <span className="accent-green">Melissa</span>! <br /> <br /> I’ve never
          had a recruiter with such{" "}
          <span className="accent-green">amazing response times</span>—you answered{" "}
          <span className="accent-green">all my questions and concerns</span>, like
          sponsorship, so swiftly and even kept me informed about your travels.{" "}
          <br /> <br /> It was{" "}
      ...
      default: (
        <>
          ...
          approach to an email follow-up—React, HTML, CSS style. <br /> <br /> It’s
          my way of combining{" "}
          <span className="accent-green">
